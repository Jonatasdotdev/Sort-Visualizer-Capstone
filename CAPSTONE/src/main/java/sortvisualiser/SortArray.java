...
public class SortArray extends JPanel {
    ...
    /** porcentaqgem do painel que as barras vao consumir baseado no
     * original 256 barras cada sendo 2x sua propria altura e 720 pixels altura
     * da janela ou 512/720
     */
    ...
    private UiSortAlgoritimo algorithm;
    private long algorithmDelay = 0;

    private JSpinner spinner;
    private int arrayChanges = 0; // Numero de mundanças do array
    ...
    // Pega o Máximo Valor do Array ou Integer.MIN_VALUE e se não tiver retorna o máximo valor ou Integer.MIN_VALUE
